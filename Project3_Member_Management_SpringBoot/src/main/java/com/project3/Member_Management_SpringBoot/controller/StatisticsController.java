...
public class StatisticsController {
    ...
    @RoleRequire("admin")
    public @ResponseBody
    String statisticDevice(Model theModel, @RequestParam("search") String name, @RequestParam("select") String type, @RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate) {
